      ...
      <div className="basis-3/4 ">
        {state.selectedItems.length > 0 ? (
          ...
          <div className="my-2 w-3/4 rounded-xl flex justify-around flex-col xs:flex-row  items-center h-32 bg-white mx-auto shadow-md border-t-2">
            ...
            {!state.isChekedOut && (
              <button className="bg-gradient-to-r from-cyan-500 to-indigo-700 text-white rounded-md px-2">
      ...
      <div className="basis-1/4">
        {state.isChekedOut && (
          <div className="bg-white w-5/6 mx-auto my-2 p-3 h-64 rounded-md shadow-md flex flex-col justify-evenly border-t-2">
            ...
            <button className="px-2 bg-gradient-to-r from-cyan-500 to-indigo-700 text-white font-medium rounded-lg">
        ...
        {!state.isChekedOut && (
          <div className="flex flex-col justify-evenly bg-white w-5/6 mx-auto my-2 p-3 h-64 rounded-md shadow-md border-t-2">
            <div>
              <div>
                <h4 className=" text-lg font-bold text-blue-700 ml-2 inline-block">
                  Total Count:{" "}
                </h4>
            ...
            <div className="ml-2 flex justify-between xl:flex-row flex-col-reverse">
              ...
              <button
                className="bg-gradient-to-r from-cyan-500 to-indigo-700 text-white px-2 rounded-md shadow-sm mb-2 xl:mb-0"
